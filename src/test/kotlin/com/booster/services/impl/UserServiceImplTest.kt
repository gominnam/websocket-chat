...
class UserServiceImplTest {
    ...
    fun `it should throw user already exists with given email`() {
        val user = User(1L, email="booster@naver.com", name="name", password="booster", "", Role.USER, null, "", "")
    ...
    fun `it should create user with given email and name and password`(){
        val savedUser = User(1L, email="booster@naver.com", name="name", password="booster", "", Role.USER, null, "", "")
    ...
    fun `it should get user with given email and password`(){
        val user = User(1L, email="email", name="name", password="password", "", Role.USER, null, "", "")
